...
class ResetTask extends shared_js_1.SignedRequest {
    ...
    submitTask(signature) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.addResetTask(this.createSignedTaskParams());
        });
    }
    addResetTask(task) {
        return __awaiter(this, void 0, void 0, function* () {
            let response = yield this.helper.sendRequestWithSignature("POST", service_helper_js_1.TaskEndpoint.RESET, task, true);
