...
class SetupTask extends shared_js_1.SignedRequest {
    ...
    submitTask(signature) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.addNewWasmImage(this.createSignedTaskParams());
        });
    }
    addNewWasmImage(task) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.helper.sendRequestWithSignature("POST", service_helper_js_1.TaskEndpoint.SETUP, task, true);
